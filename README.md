...
const jisha = {
    pronouns: "she/her",
    focus: ["Computer Vision & Deep Learning", "Post-Quantum Cryptography", "Full-Stack Development"],
    currentWork: "Multimodal medical image fusion & remote sensing radar analysis",
    traits: ["Problem Solver", "Continuous Learner", "Builder"]
};
